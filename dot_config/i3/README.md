...
- **Launcher**: rofi styled to match the Catppuccin palette with rounded corners and accent border
- **Gaps**: 1px inner, 1px outer
- **Border width**: 2px
...
├── rofi/
│   └── config.rasi         # Generated by Home Manager from `rofi.nix`
├── picom/
