...
return {
  ...
  opts = {},
  keys = {
    { "s",     function() require("flash").jump() end,              mode = { "n", "x", "o" }, desc = "Jump to any match on screen" },
    { "S",     function() require("flash").treesitter() end,        mode = { "n", "x", "o" }, desc = "Select treesitter node" },
